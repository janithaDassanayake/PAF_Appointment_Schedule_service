 ...
 <br>
	<div class="container">
		<div class="row">
			<div class="col-md-3">
				...
				<form id="formSchedule" name="formSchedule">
							...
							<input id="App_id" name="App_id" type="number"
								class="form-control form-control-sm" min="1" title="Three letter country code"> 
							<br> 
			...
			<div class="col-md-9">
				<div class="container">
					<h3 align="center">Appointment Schedule Action</h3>
					<br>
						<div id="divScheduleGrid1" class="table table-striped">
							<%
